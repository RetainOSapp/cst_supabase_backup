...
- `[x]` Pipeline Phases 0-4, early-renewal scheduling, and the Gate F frontend release are live.
  ...
  - ES is visible; MM was disabled after the video setup. On 2026-07-22 Jay enabled Sales Kick's master gate and created the default Renewal/Expansion starters; both definitions remain individually disabled, automation is off, and there are zero items. Viewer access remains off and there are zero pending scheduled activations.
