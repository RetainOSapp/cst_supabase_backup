...
- `[x]` 2026-06-21 Advocacy tracking QA passed.
  ...
  - 2026-07-08 MM launch fix: Dashboard Advocacy & Growth counts/drilldowns include migrated client advocacy summary dates as fallback records when `client_advocacy_events` is missing historical rows.
