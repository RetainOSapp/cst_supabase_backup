...
- `[~]` `[qa]` 2026-06-20 Secondary pathway support is ready for Jay QA.
  ...
  - 2026-07-02 QA fix 3: Secondary Pathway expanded progress now has its own Start/Complete Secondary Milestone actions. `manage-client-milestone` supports secondary start/complete actions and updates the secondary current fields instead of the main pathway. Awaiting Jay retest.
