...
- `[~]` `[mixed]` `[priority: high]` Automatically ingest meeting transcripts through Zapier plus Fathom or equivalent integration.
  - 2026-08-04 MM offboarded-profile reconciliation candidate: reconciliation search includes nonarchived offboarded profiles plus primary/secondary/tertiary emails; automatic call-summary and transcript matching prefers a unique active client, then a unique offboarded fallback. Archived profiles and ambiguous email reuse remain fail-closed. Production audit finds 16 of 23 open MM events safe for exact offboarded retry and 6 requiring manual review. Await production release and Jay/Jhoyce QA. [qa]
