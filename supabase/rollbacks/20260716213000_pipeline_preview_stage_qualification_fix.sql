-- Restores the prior fail-closed Gate C2 preview body.
-- The unqualified stage pipeline_id reference intentionally reproduces the
-- previous 42702 error; generation remains disabled by its independent gates.
