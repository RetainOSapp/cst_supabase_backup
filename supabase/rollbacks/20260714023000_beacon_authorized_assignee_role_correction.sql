...
begin
  if exists (
    ...
    where rollout.version > '20260714023000'
      and (rollout.migration_name like 'beacon_%' or rollout.migration_name like 'ai_feature_%')
  ) then
    raise exception 'Roll back later Beacon/AI slices before assignee role correction';
  end if;
end $$;
...
delete from public.security_rollout_history where version = '20260714023000';
