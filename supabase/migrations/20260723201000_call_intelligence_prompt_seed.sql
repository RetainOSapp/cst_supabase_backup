...
action_plan. Return only schema-valid JSON.',
  '{"type":"object","additionalProperties":false,"required":["schema_version","call_type","title_label","summary","client_sentiment","team_member_sentiment","negative_signals","positive_signals","client_pain_points","next_steps","call_score","archetype"],"properties":{"schema_version":{"type":"string","enum":["call_intelligence.v2"]},"call_type":{"type":"string","enum":["onboarding","check_in","renewal","upsell","escalation","other"]},"title_label":{"type":"string","minLength":1,"maxLength":160},"summary":{"type":"string","minLength":1,"maxLength":2500},"client_sentiment":{"type":"object","additionalProperties":false,"required":["label","confidence","evidence"],"properties":{"label":{"type":"string","enum":["positive","neutral","negative","insufficient_evidence"]},"confidence":{"type":"string","enum":["low","medium","high"]},"evidence":{"type":"array","maxItems":1,"items":{"type":"object","additionalProperties":false,"required":["timestamp","speaker_role","quote"],"properties":{"timestamp":{"type":"string","description":"Timestamp exactly as supported by the transcript, or an empty string when unavailable."},"speaker_role":{"type":"string","enum":["client","team_member","unknown"]},"quote":{"type":"string","minLength":1,"maxLength":120,"description":"One short, uninterrupted, word-for-word excerpt copied from the cited transcript utterance."}}}}}},"team_member_sentiment":{"type":"object","additionalProperties":false,"required":["label","confidence","evidence"],"properties":{"label":{"type":"string","enum":["positive","neutral","negative","insufficient_evidence"]},"confidence":{"type":"string","enum":["low","medium","high"]},"evidence":{"type":"array","maxItems":1,"items":{"type":"object","additionalProperties":false,"required":["timestamp","speaker_role","quote"],"properties":{"timestamp":{"type":"string","description":"Timestamp exactly as supported by the transcript, or an empty string when unavailable."},"speaker_role":{"type":"string","enum":["client","team_member","unknown"]},"quote":{"type":"string","minLength":1,"maxLength":120,"description":"One short, uninterrupted, word-for-word excerpt copied from the cited transcript utterance."}}}}}},"negative_signals":{"type":"array","maxItems":3,"items":{"type":"object","additionalProperties":false,"required":["label","summary","emotions","evidence"],"properties":{"label":{"type":"string","maxLength":100},"summary":{"type":"string","maxLength":500},"emotions":{"type":"array","maxItems":3,"items":{"type":"string","maxLength":60}},"evidence":{"type":"array","maxItems":1,"items":{"type":"object","additionalProperties":false,"required":["timestamp","speaker_role","quote"],"properties":{"timestamp":{"type":"string","description":"Timestamp exactly as supported by the transcript, or an empty string when unavailable."},"speaker_role":{"type":"string","enum":["client","team_member","unknown"]},"quote":{"type":"string","minLength":1,"maxLength":120,"description":"One short, uninterrupted, word-for-word excerpt copied from the cited transcript utterance."}}}}}}},"positive_signals":{"type":"array","maxItems":3,"items":{"type":"object","additionalProperties":false,"required":["label","summary","emotions","evidence"],"properties":{"label":{"type":"string","maxLength":100},"summary":{"type":"string","maxLength":500},"emotions":{"type":"array","maxItems":3,"items":{"type":"string","maxLength":60}},"evidence":{"type":"array","maxItems":1,"items":{"type":"object","additionalProperties":false,"required":["timestamp","speaker_role","quote"],"properties":{"timestamp":{"type":"string","description":"Timestamp exactly as supported by the transcript, or an empty string when unavailable."},"speaker_role":{"type":"string","enum":["client","team_member","unknown"]},"quote":{"type":"string","minLength":1,"maxLength":120,"description":"One short, uninterrupted, word-for-word excerpt copied from the cited transcript utterance."}}}}}}},"client_pain_points":{"type":"array","maxItems":10,"items":{"type":"object","additionalProperties":false,"required":["summary","evidence"],"properties":{"summary":{"type":"string","minLength":1,"maxLength":500},"evidence":{"type":"array","maxItems":1,"items":{"type":"object","additionalProperties":false,"required":["timestamp","speaker_role","quote"],"properties":{"timestamp":{"type":"string","description":"Timestamp exactly as supported by the transcript, or an empty string when unavailable."},"speaker_role":{"type":"string","enum":["client","team_member","unknown"]},"quote":{"type":"string","minLength":1,"maxLength":120,"description":"One short, uninterrupted, word-for-word excerpt copied from the cited transcript utterance."}}}}}}},"next_steps":{"type":"array","maxItems":12,"items":{"type":"object","additionalProperties":false,"required":["owner","action","due_date","evidence"],"properties":{"owner":{"type":"string","maxLength":160},"action":{"type":"string","minLength":1,"maxLength":500},"due_date":{"type":"string","description":"ISO date only when explicitly agreed, otherwise an empty string."},"evidence":{"type":"array","maxItems":1,"items":{"type":"object","additionalProperties":false,"required":["timestamp","speaker_role","quote"],"properties":{"timestamp":{"type":"string","description":"Timestamp exactly as supported by the transcript, or an empty string when unavailable."},"speaker_role":{"type":"string","enum":["client","team_member","unknown"]},"quote":{"type":"string","minLength":1,"maxLength":120,"description":"One short, uninterrupted, word-for-word excerpt copied from the cited transcript utterance."}}}}}}},"call_score":{"type":"object","additionalProperties":false,"required":["total","agenda","team_member_energy","recap","action_plan"],"properties":{"total":{"type":"integer","minimum":0,"maximum":28},"agenda":{"type":"object","additionalProperties":false,"required":["score","rationale","evidence"],"properties":{"score":{"type":"integer","enum":[0,1,3,5,7]},"rationale":{"type":"string","maxLength":600},"evidence":{"type":"array","maxItems":1,"items":{"type":"object","additionalProperties":false,"required":["timestamp","speaker_role","quote"],"properties":{"timestamp":{"type":"string","description":"Timestamp exactly as supported by the transcript, or an empty string when unavailable."},"speaker_role":{"type":"string","enum":["client","team_member","unknown"]},"quote":{"type":"string","minLength":1,"maxLength":120,"description":"One short, uninterrupted, word-for-word excerpt copied from the cited transcript utterance."}}}}}},"team_member_energy":{"type":"object","additionalProperties":false,"required":["score","rationale","evidence"],"properties":{"score":{"type":"integer","enum":[0,1,3,5,7]},"rationale":{"type":"string","maxLength":600},"evidence":{"type":"array","maxItems":1,"items":{"type":"object","additionalProperties":false,"required":["timestamp","speaker_role","quote"],"properties":{"timestamp":{"type":"string","description":"Timestamp exactly as supported by the transcript, or an empty string when unavailable."},"speaker_role":{"type":"string","enum":["client","team_member","unknown"]},"quote":{"type":"string","minLength":1,"maxLength":120,"description":"One short, uninterrupted, word-for-word excerpt copied from the cited transcript utterance."}}}}}},"recap":{"type":"object","additionalProperties":false,"required":["score","rationale","evidence"],"properties":{"score":{"type":"integer","enum":[0,1,3,5,7]},"rationale":{"type":"string","maxLength":600},"evidence":{"type":"array","maxItems":1,"items":{"type":"object","additionalProperties":false,"required":["timestamp","speaker_role","quote"],"properties":{"timestamp":{"type":"string","description":"Timestamp exactly as supported by the transcript, or an empty string when unavailable."},"speaker_role":{"type":"string","enum":["client","team_member","unknown"]},"quote":{"type":"string","minLength":1,"maxLength":120,"description":"One short, uninterrupted, word-for-word excerpt copied from the cited transcript utterance."}}}}}},"action_plan":{"type":"object","additionalProperties":false,"required":["score","rationale","evidence"],"properties":{"score":{"type":"integer","enum":[0,1,3,5,7]},"rationale":{"type":"string","maxLength":600},"evidence":{"type":"array","maxItems":1,"items":{"type":"object","additionalProperties":false,"required":["timestamp","speaker_role","quote"],"properties":{"timestamp":{"type":"string","description":"Timestamp exactly as supported by the transcript, or an empty string when unavailable."},"speaker_role":{"type":"string","enum":["client","team_member","unknown"]},"quote":{"type":"string","minLength":1,"maxLength":120,"description":"One short, uninterrupted, word-for-word excerpt copied from the cited transcript utterance."}}}}}}}},"archetype":{"type":"object","additionalProperties":false,"required":["label","confidence","evidence"],"properties":{"label":{"type":"string","enum":["doer","controller","worrier","follower","insufficient_evidence"]},"confidence":{"type":"string","enum":["low","medium","high"]},"evidence":{"type":"array","maxItems":1,"items":{"type":"object","additionalProperties":false,"required":["timestamp","speaker_role","quote"],"properties":{"timestamp":{"type":"string","description":"Timestamp exactly as supported by the transcript, or an empty string when unavailable."},"speaker_role":{"type":"string","enum":["client","team_member","unknown"]},"quote":{"type":"string","minLength":1,"maxLength":120,"description":"One short, uninterrupted, word-for-word excerpt copied from the cited transcript utterance."}}}}}}}}'::jsonb,
  'structured_v2_evidence_v1', 'active'
) on conflict do nothing;
