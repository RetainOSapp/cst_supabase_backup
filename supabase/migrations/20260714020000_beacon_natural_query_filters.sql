...
values (
  '20260714020000',
  'beacon_natural_query_filters',
  jsonb_build_object(
    'service_only', true,
    'partial_names_unique_only', true,
    'combined_health_risk_states', array['red', 'yellow'],
    'max_rows', 50,
    'rollback', '20260714020000_beacon_natural_query_filters.sql'
  )
);
