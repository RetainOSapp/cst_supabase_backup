...
- 2026-07-20 Pipeline Gate F is live on production `main` at `fb4e3da` / Vercel asset `index-cBDhoZ9O.js`. Role smoke and final postflight passed with zero writes/residue; ES/MM are on, Sales Kick off, Viewer off, all automation paused, and zero pending activations. Use `PIPELINE_GATE_F_FRONTEND_RELEASE_PREP_2026-07-20.md`; Jay's authenticated visual click-through and MM observation week remain.
