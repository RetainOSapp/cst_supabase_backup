...
- Moves Method Resource guide + shell seed script update is committed locally but not pushed to GitHub/Vercel yet; push to `main` requires Jay's explicit approval because it deploys live.
