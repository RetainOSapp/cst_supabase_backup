...
- 2026-07-24 Call Intelligence V1 local candidate on `codex/call-intelligence-v1`: 45/45 private Terra-medium baseline calls completed for $1.849210. Structured used 86.2% fewer input tokens, cost 75.5% less, cut cumulative latency 48.0%, and was schema-valid 5/5, but failed promotion because only 146/197 quotes were exact within the cited timestamp and 0/5 calls passed all evidence. `structured_v2_evidence_v1` now permits one 4–12-word contiguous quote per claim, rejects wrong-timestamp/stitched evidence and timestamp-speaker role mismatches, uses only sanitized matched participant name/role context, and mechanically syncs the migration seed. Gates: Edge 18/18, eval 4/4, DB 54/54, source 43/43, frontend 19/19, build. Five-call structured-only retest ceiling is 1,122,829 micros ($1.13 rounded) and remains unapproved/unrun. No production migration/function/frontend deploy, token, entitlement, allowance, or Zap change occurred.
