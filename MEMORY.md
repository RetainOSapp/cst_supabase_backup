...
- Verification: `npm run build` passed. Awaiting Jay retest of Director CSM Reports and company resource create/edit, then continue CSM/Support role QA.
...
- Support QA warning: live `jay+mm-support-qa@ethicalscaling.com` currently resolves as `role = director`; flip to Support before running Support role QA.
