...
- 2026-07-24 Call Intelligence V1 local candidate on `codex/call-intelligence-v1`: the 45-call private Terra-medium baseline cost $1.849210 and failed promotion at 146/197 timestamp-grounded quotes / 0/5 hard passes. Evidence-v1's 5-call retest cost $0.372006 with no retries and also failed safely at 55/67 grounded, 42/67 correctly attributed, and 0/5 accepted calls. Evidence-v2 now sends explicit timestamped utterance records plus a sanitized speaker-role map, requires evidence fields from one record, preserves unmatched/ambiguous labels as `unknown`, machine-enforces 4–12 quote words with strict-schema `pattern`, and syncs the seed. Gates: Edge 18/18, eval 4/4, DB 54/54, source 47/47, frontend 19/19, build. The evidence-v2 five-call retest ceiling is 1,176,566 micros ($1.18 rounded) and remains unapproved/unrun. No production migration/function/frontend deploy, token, entitlement, allowance, or Zap change occurred.
