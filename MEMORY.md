...
- 2026-07-24 active checkpoints: Call Intelligence tab/API require effective `call_analysis` entitlement (ES only; Moves off). Pipeline role access/one-time scan is live at `ac2f5b1`; MM is Director-only, recurring renewal scheduling remains off, and runtime proof changed zero Pipeline items/runs.
