...
- 2026-08-05 local checkpoint: branch `codex/client-interaction-orchestration` adds company-configurable call types, typed Quick Update/Fathom attendance, Daily Pulse Strategic Review evidence plus forward-only Pipeline movement, Client Outcomes/Pipeline summaries, and a preview-first historical repair. No deploy, push, metadata configuration, or data write occurred; Jay QA is next.
