...
- 2026-07-22 Pipeline Gate F is live; MM is off. Sales Kick's master gate is on with default Renewal/Expansion starters individually disabled, zero items, Viewer off, and automation off. Release `666ce6d` makes sidebar visibility follow the master gate even before enabled definitions exist and refresh immediately after Settings save. Sales Kick configuration and MM feedback remain.
