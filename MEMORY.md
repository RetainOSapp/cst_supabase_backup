...
- 2026-07-24 active checkpoints: Call Intelligence ES-only pilot first call + buy-in prompt cost $0.14388. Native Fathom `0:00` timestamps had caused zero parsed utterances; corrected replay resolves 164 with client/team/unknown roles, and on-demand runs now auto-refresh. Reprocess this call once before adding calls. Pipeline MM preview uses current-contract evidence and complete pagination: 4,686 checked, 683 eligible in the configured 30-day catch-up + 45-day lead window, 3 already tracked, 7 Pipeline rows unchanged, 0 automation runs; recurring scheduling stays off.
