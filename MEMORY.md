...
- 2026-07-24 Call Intelligence company-gate correction: its tab/API require an effective `call_analysis` entitlement; the SuperAdmin AI Features card now configures start/pause/disable plus USD cap. Reconciliation remains independent. Production readback: ES pilot only; Moves has no entitlement.
