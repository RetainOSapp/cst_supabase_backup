...
- 2026-07-27 active checkpoints: Call Intelligence ES manual-pilot spend is $0.385236; one real Fathom/Zapier webhook delivery is next. Pipeline bounded rollout `5c7fe9e` is live with migrations `20260727120000`/`20260727121000` and the JWT-on automation boundary. Global scheduler and renewal materialization are paused, 0 companies are enrolled, 0 preview tokens exist, the new cron is inert, and the independent early-renewal cron remains singular/active. Five untouched MM video-demo rows were audited-archived; MM has 0 visible Pipeline items. Jay's next QA is an explicit 7-day, cap-10 preview and SuperAdmin run; do not enable recurrence or broad cohorts before that QA.
