...
- 2026-08-05 MIA dropoff-label local candidate: keep `auto_suspended_timeout`, preserve company-edited labels, label MM `Dropoff — MIA timeout`, and show exit outcome/reason in Client Details and automated History; Churn Reasons already resolves the same company label and selected offboard period. No production migration or client/history backfill has run.
