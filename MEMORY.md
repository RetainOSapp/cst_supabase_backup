...
- 2026-07-24 Call Intelligence disabled Phases A–C are live through `90655e0`: foundation `a6a12b62...` and quality-v4 seed `2b9e2594...` applied; ingest/manage/process active v1 with correct JWT gates; invalid/missing token and anonymous probes deny; Vercel Ready at `app.retainos.ai` with DEV fixture/provider credentials absent. Global `call_analysis` remains paused with zero entitlements, allowances, tokens, calls, transcripts, runs, usage, or provider spend. Gates: Edge 21/21, eval 5/5, DB 56/56, source 56/56, frontend 23/23, QA viewer 21/21, build, desktop/mobile. No company may be enabled before the separately gated Ethical Scaling pilot.
