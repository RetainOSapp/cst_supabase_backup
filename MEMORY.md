...
- 2026-07-24 active checkpoints: Call Intelligence ES manual-pilot spend is $0.385236. Two manual base analyses, corrected reprocessing, evidence navigation, and one on-demand prompt passed Jay QA. Production migration `20260724180000` (`91427810eb0f0898c159c9cbaf1fc1fa70291e46688eba93a52c75017af04e36`) restores completed call state after terminal on-demand runs; worker alias matching resolves `Angus Parker (Ali Abdaal)` as client, with zero-cost replay at 65 client/64 team/0 unknown. One real Fathom/Zapier webhook delivery is next. Pipeline MM preview: 4,686 checked, 683 eligible, 3 tracked, 7 Pipeline rows unchanged, 0 runs; recurring scheduling off.
