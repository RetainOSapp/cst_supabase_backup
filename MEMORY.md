...
- 2026-07-24 Call Intelligence V1 local candidate on `codex/call-intelligence-v1`: quality-v3 retest cost $0.286526; 3/3 eligible private calls passed with 42/42 citations, two identity collisions quarantined at $0, and the synthetic injection call passed 1/1 with 4/4 citations/all six expectations. Independent review found no P0-P3 blocker; total evaluation history is 59/59 requests and $2.878853. Gates: Edge 20/20, eval 5/5, DB 54/54, source 56/56, frontend 19/19, build. Localhost-only private QA viewer covers all six use cases with side-by-side evidence and browser-local feedback; artifact 19/19 and browser QA 1440×900/390×844 pass. Candidate is at the disabled-first production/pilot gate; no production migration/function/frontend deploy, token, entitlement, allowance, or Zap change occurred.
