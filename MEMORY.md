...
- 2026-07-22 Pipeline Gate F is live; MM is now off and Jay enabled Sales Kick's master gate with zero definitions/items, Viewer off, and all automation paused. The release candidate fixes sidebar visibility to follow the master gate even before starters exist and refresh immediately after Settings save. Use `PIPELINE_GATE_F_FRONTEND_RELEASE_PREP_2026-07-20.md`; Sales Kick configuration and MM feedback remain.
