...
- 2026-07-23 Churn Reasons chart period fix: production migration `20260723120000` (`0f2af9dcf3d5792ee59758fc60fafc1f091cac99e07ef91f919c56596652840d`) filters the actor-scoped aggregate by real recorded offboard date; the frontend distribution and drilldown use the same rule and never substitute contract end. MM production evidence is 67 dated churn records in June versus 50 in July. Frontend source push and Jay/MM QA remain.
