...
- 2026-07-24 Call Intelligence ES authenticated-manual pilot is live through `b713b33`: management v2 JWT-on; DB 70/70, Edge 63/63, frontend 28/28, tests/build/browser pass. ES is the only entitlement with a one-time $1 hard cap at $0 used; global config v2 active. No webhook token, calls, transcripts, runs, usage, provider spend, or Zapier automation exists. Jay's first known-client upload is next; keep its raw transcript until pilot approval, then decide ongoing retention.
